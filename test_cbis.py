...
from utils.dataloader import folder_test_dataset
import imageio
...
if __name__ == '__main__':
    ...
    img_dir = os.path.join(opt.test_path, 'img')
    gt_dir = os.path.join(opt.test_path, 'msk')
    test_loader = folder_test_dataset(img_dir, gt_dir)
