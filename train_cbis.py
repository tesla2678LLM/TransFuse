...
from utils.dataloader import get_folder_loader, folder_test_dataset
...
def test(model, path):
    ...
    mask_dir = os.path.join(path, 'msk')
    test_loader = folder_test_dataset(img_dir, mask_dir)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str,
                        default='/data/xudosong/Transfer_Scratch/CBIS_max_last_withAug3_noise/CBIS_pre/training_data_all_CBIS_256',
                        help='path to train dataset')
    parser.add_argument('--test_path', type=str,
                        default='/data/xudosong/Transfer_Scratch/CBIS_max_last_withAug3_noise/CBIS_pre/test_data_all_CBIS_256',
                        help='path to test dataset')
    parser.add_argument('--train_save', type=str, default='TransFuse_CBIS')
    ...
    train_loader = get_folder_loader(os.path.join(opt.train_path, 'img'),
                                    os.path.join(opt.train_path, 'msk'),
